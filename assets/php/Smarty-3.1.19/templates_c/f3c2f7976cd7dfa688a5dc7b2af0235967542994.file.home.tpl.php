<?php /* Smarty version Smarty-3.1.19, created on 2014-09-28 22:58:44
         compiled from "apps/frontend/views/dashboard/home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9120740775428bb5962b145-06155905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f3c2f7976cd7dfa688a5dc7b2af0235967542994' => 
    array (
      0 => 'apps/frontend/views/dashboard/home.tpl',
      1 => 1411955900,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9120740775428bb5962b145-06155905',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5428bb59646e64_59649214',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5428bb59646e64_59649214')) {function content_5428bb59646e64_59649214($_smarty_tpl) {?>	
		<!-- start: Content -->
		<div class="main ">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4">
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<h2><i class="fa fa-check"></i>Browser</h2>
				...
				<div class="col-lg-6 col-md-8">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<i class="fa fa-check"></i><h2>Traffic</h2>
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								<thead>
								  ...
								  <tbody>
										<tr>
											<td><img src="ico/flags/USA.png" style="height:18px; margin-top:-2px;"></td>
											<td>USA</td>
											<td>10.982</td>
											<td>180.322</td>
											<td>
										...
										<tr>
											<td><img src="ico/flags/India.png" style="height:18px; margin-top:-2px;"></td>
											<td>India</td>
											<td>9.822</td>
											<td>130.326</td>
											<td>
										...
										<tr>
											<td><img src="ico/flags/Brazil.png" style="height:18px; margin-top:-2px;"></td>
											<td>Brazil</td>
											<td>6.124</td>
											<td>101.333</td>
											<td>
												<div class="progress thin">
													...
													<div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="7" aria-valuemin="0" aria-valuemax="100" style="width: 7%">
												  	</div>
												</div>
										...
										<tr>
											<td><img src="ico/flags/Russia.png" style="height:18px; margin-top:-2px;"></td>
											<td>Russia</td>
											<td>4.823</td>
											<td>81.325</td>
											<td>
			...
			<div class="row">
				...
				<div class="col-lg-3">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p><small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.</small></p>
							...
							<ul>
								<li>
									<label class="custom-checkbox-item">
										...
										<span class="custom-checkbox-desc">Meeting with John Doe</span>
								...
								<li>
									<label class="custom-checkbox-item">
										<input class="custom-checkbox" type="checkbox"/>
										<span class="custom-checkbox-mark"></span>
										<span class="custom-checkbox-desc">Cinema - Godzilla</span>
								...
								<li>
									<label class="custom-checkbox-item">
										<input class="custom-checkbox" type="checkbox"/>
										<span class="custom-checkbox-mark"></span>
										<span class="custom-checkbox-desc">Product Launch</span>
						...
						<li>
							...
							<div class="message row">
								<div class="col-sm-3 col-xs-6">
									<img src="img/gallery/photo2.jpg" class="img-responsive img-thumbnail">
								</div>
								<div class="col-sm-3 col-xs-6">
									<img src="img/gallery/photo3.jpg" class="img-responsive img-thumbnail">
								</div>
								<div class="col-sm-3 col-xs-6">
									<img src="img/gallery/photo4.jpg" class="img-responsive img-thumbnail">
								</div>
								<div class="col-sm-3 col-xs-6">
									<img src="img/gallery/photo5.jpg" class="img-responsive img-thumbnail">
								</div>	
							</div>	
